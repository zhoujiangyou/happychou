...
class Pay {
    ...
    public function __construct($driver, $config = array()) {
        ...
        $this->config['notify_url'] = U("User/Payment/notify", array('apitype' => $apitype, 'method' => 'notify'), false, true);
        $this->config['return_url'] = U("User/Payment/notify", array('apitype' => $apitype, 'method' => 'return'), false, true);
